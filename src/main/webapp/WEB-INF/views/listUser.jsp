...
-->
		<style type="text/css" title="currentStyle">
			...
			@import "${pageContext.request.contextPath}/resources/css/jquery-ui-1.8.6.custom.css";
		</style>

		<script type="text/javascript" src="<c:url value="/resources/js/jquery-1.3b1.js" />"></script>
